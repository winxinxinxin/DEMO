...
public class TraceButton extends AppCompatButton{
    ...
    public TraceButton(Context context) {
        super(context);
        mContext = context;
    }

    public TraceButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    }

    public TraceButton(Context context, AttributeSet attrs, int defStyleAttr) {
